...
<div class="footer-pri">
    ...
    <div class="col-sm-2 footer-widget">
        ...
        <ul class="quick-links">
            ...
            <li><a href="about.php">About Sayun Company</a></li>
            <li><a href="service.php">Our Services</a></li>
            <li><a href="google_map.php">Visit us on map</a></li>
...
<div class="row">
    <div class="col-sm-6 text-center">
        <span class="copyright">&copy; Copyright Sayun Company for medical appliances.</span><br>
