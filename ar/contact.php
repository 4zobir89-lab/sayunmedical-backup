    ...
    <div class="row">
        ...
        <div class="col-sm-5 mt-20">
            ...
            <ul class="social">
                ...
                <li><a href="mailto:sayunmedical@gmail.com"><i class=" fa fa-google"></i></a></li>
                <li><a href="mailto:info@sayunmedical.com"><i class=" fa fa-envelope"></i></a></li>
            </ul>
        </div>
...
<div class="container mt-100 mb-100">
    <div class="row">
        <div class="col-sm-12 no-gutter">
            <h2 class="heading text-center"><span class="color2">الخريطة</span>
                <span class="sub-heading">قم بزيارتنا على الخريطة</span>
