                        ...
                        <li><a href="#">Products</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="#"> Furniture <i class="fa fa-angle-right pull-right"></i></a>
                                    <ul class="sub-menu">
                                        <!-- Sub Sub Menu -->
                                        <li><a href="cabinet_work_table_sink.php">Cabinet Work Table Sink</a></li>
                                        <li><a href="hospital_bed.php">Hospital Bed</a></li>
                                        <li><a href="hospital_trolley.php">Hospital Trolley</a></li>
                                    </ul>
                                </li>
